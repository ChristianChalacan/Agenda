 ...
 * @author
 */
public class WinEditar extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
