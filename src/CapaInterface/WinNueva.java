 ...
 * @author SANTI
 */
public class WinNueva extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinNueva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
